...
public class TOTPUtil {
     ...
     * 柔性时间回溯
     */
    private static final long FLEXIBILITY_TIME = 5000;
    ...
    public boolean verify(String id, String secretKey, String code) {
        long now = new Date().getTime();
        String time = Long.toHexString(timeFactor(now - FLEXIBILITY_TIME)).toUpperCase();
        String tempTotp = generateTOTP(id + secretKey, time);
        return tempTotp.equals(code);
    }
